      ...
      <div className="container relative" ref={parallaxRef}>
        ...
        md:mb-20 lg:mb:[6rem] ">
          <h1 className="h1 mb-6">
            Explore the Possibilities of Movie with 
            <span className="inline-block relative">&nbsp;Filmbert 
              <img src={curve} className="absolute top-full left-0 wifull xl:-mt-2"
              width={624}
              height={28}
              alt="Curve"/>
            </span>
          </h1>
{/* CHANGE PRICING TO A BUTTON WHERE THE USER GOES TO A 
PAGE WHERE THEY CAN START INPUTTING DESCRIPTIONS */}
        ...
        <div className="relative max-w-[23rem] mx-auto md:max-w-5xl xl:mb-24">
          <div className="relative z-1 p-0.5 rounded-2xl bg-conic-gradient">
            <div className="relative bg-n-8 rounded-[1rem]">
              ...
              <div className="aspecct-[33/40] rounded-b-[0.9rem] overflow-hidden
              md:aspect-[688/490] lg:aspect-[1024/490]">
                <img 
                src={robot} 
                className="w-full scale-[1.7] translate-y-[8%] md:scale-[1] 
                md:-translate-y-[10%] lg:-translate-[23%]"
                width={1024}
                height={490}
                ai="AI"
                />
